...
public class MathsQuizActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Quiz> allQuizzes = QuizRepository.getMathsQuizzes();
    ...
    private void showFinalScore() {
        ...
        Intent intent = new Intent(MathsQuizActivity.this, ResultActivity.class);
