...
public class MathsBioQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Quiz> allQuizzes = QuizRepository.getMathsBioQuizzes();
    ...
    private void showFinalScore() {
        ...
        if (score >= 80) {
            finalScoreMessage = "You will be good at Engineering & Medical";
        ...
        Intent intent = new Intent(MathsBioQuizActivity.this, ResultActivity.class);
